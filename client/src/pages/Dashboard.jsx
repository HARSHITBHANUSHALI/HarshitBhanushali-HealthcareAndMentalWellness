  ...
  return (
    <div className={`flex ${theme === 'light' ? '' : 'bg-black text-white'}`}>
      ...
      <div className={`p-4 w-full overflow-hidden mt-[76px] ${theme === 'light' ? '' : 'bg-black text-white'}`}>
        ...
        <button className='p-3 mb-5 bg-gray-500' onClick={() => handleClick()}>Generate Report</button>
        ...
        >
          <div className="text-left flex-1 ml-8">
            <h4 className="text-xl font-semibold ml-10">Near By Relaxation Spots</h4>
          </div>
          <img src={c2} alt="Study Material DOST" className="w-56 h-56 mx-4" />
        </Link>
      ...
      <div className='grid  gap-4 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 mb-4'>
        <div
          className="bg-pink-100 p-4 rounded-3xl h-64 w-80 ml-32 flex items-center justify-center shadow-none transition-shadow duration-300 cursor-pointer hover:shadow-lg hover:shadow-gray-400"
        >
          <div className="text-left flex-1 ml-8">
            <h4 className="text-xl font-semibold text-center">Events Attended</h4>
            <p className='text-sm text-center'>2</p>
          </div>
        </div>

        <div
          className="bg-red-100 p-4 rounded-3xl h-64 w-80 flex items-center justify-center shadow-none transition-shadow duration-300 cursor-pointer hover:shadow-lg hover:shadow-gray-400"
        >
          <div className="text-left flex-1 items-center justify-center ml-8">
            <h4 className="text-xl font-semibold text-center">Appointments booked</h4>
